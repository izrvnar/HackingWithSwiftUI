...
class Order: ObservableObject, Codable{
    ...
    //computed property for address check
    ...
    // conforming order to codable by adding enum coding keys
    ...
    // other init to not ruin the content view
    init(){
